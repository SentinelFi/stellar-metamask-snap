...
[Snapper](https://github.com/sayfer-io/Snapper) (by Sayfer) is the scanner named in MetaMask's allowlisting requirements. Run it via the `Snapper security scan` GitHub Actions workflow ([.github/workflows/snapper.yml](../../.github/workflows/snapper.yml)) — routine runs stay as downloadable CI artifacts; the report from the **frozen pre-publish / audited commit** is what gets committed here. See [docs/research/snapper-security-scan.md](../../docs/research/snapper-security-scan.md) for the assessment and how-to.
