...
- Base fee **100 stroops/operation**; the fee field is a _maximum bid_ (surge pricing = clock auction; you usually pay less).
...
- `@stellar/typescript-wallet-sdk` — anchor flows (SEP-10/24/30), key management, soroban helpers; for wallet _products_, not needed for the core snap.
